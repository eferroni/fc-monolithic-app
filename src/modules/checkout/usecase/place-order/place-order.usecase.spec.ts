...
describe('Place Order UseCase unit test', () => {
    ...
    describe('Validate products methods', () => {
        ...
        it('should thrown error id no products are selected', async () => {
    ...
    describe('Execute method', () => {
        ...
        it('should throw an error when client not found', async () => {
            ...
            await expect(placeOrderUseCase.execute(input)).rejects.toThrowError(new Error('Client not found'))
        });
        ...
        it('should throw an error when products are not valid', async () => {
            ...
            //@ts-expect-error - snot return never
